...
class NotificationModelTests(TestCase):
    def setUp(self):
        ...
        self.post = Post.objects.create(
            owner=self.adam,
            content="Adam's post content"
        )

        self.comment = Comment.objects.create(
            owner=self.brian,
            post=self.post,
            content="Brian's comment"
        )
    ...
    def test_str_representation(self):
        ...
        self.assertEqual(
            str(notification),
            f"{self.adam.username} - like - {notification.created_at}"
        )
    ...
    def test_default_ordering(self):
        ...
        self.assertTrue(
            first_notification.created_at < last_notification.created_at
        )
